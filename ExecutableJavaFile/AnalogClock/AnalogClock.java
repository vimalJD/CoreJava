...
public class AnalogClock extends JPanel {
	...
	/**
	 * You could set the TimeZone for the clock here. I used the Dfault time zone
	 * from the user so that every time the program runs on different computers the
...
//g.setStroke(new BasicStroke(9));
		...
		for (double theta = 0; theta < Math.PI * 2; theta += Math.PI / 6) {
			 ...
			 * Each pair of (x, y) coordinates defines a point. The figure is not closed if
